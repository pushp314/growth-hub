                ...
                <div className='grid grid-cols-1 md:grid-cols-2 my-16'>
                    ...
                    <div className="relative">
                        ...
                        <h2 className="text-4xl lg:text-65xl pt-4 font-bold sm:leading-tight mt-5 text-center lg:text-start">
                            Empowering You with Skills for a Brighter Career.
                        </h2>

                        {/* ✅ Updated paragraph text */}
                        <p className="font-medium text-lightblack text-2xl mt-5 text-center lg:text-start">
                            At Growthhub Training and Placement Consultancy, we help individuals master English communication, 
                            build employability, and shape their future through expert-led training and personalized career guidance.
                        </p>
