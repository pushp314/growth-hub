...
const postData: DataType[] = [
    {
        time: "7 min",
        heading: 'Mastering English Communication',
        heading2: 'Tips to improve your fluency!',
        name: "Published on SkillUp Academy",
        date: 'October 10, 2025',
        imgSrc: '/images/articles/article.png',
    },
    {
        time: "6 min",
        heading: 'Top Job Placement Strategies',
        heading2: 'How to land your dream role',
        name: "Published on CareerBoost",
        date: 'September 22, 2025',
        imgSrc: '/images/articles/article2.png',
    },
    {
        time: "5 min",
        heading: 'Career Counseling Insights',
        heading2: 'Finding the right path for you',
        name: "Published on GuidancePro",
        date: 'August 30, 2025',
        imgSrc: '/images/articles/article3.png',
    },
    {
        time: "8 min",
        heading: 'Online vs Offline English Classes',
        heading2: 'Which one suits you best?',
        name: "Published on SkillUp Academy",
        date: 'October 5, 2025',
        imgSrc: '/images/articles/article.png',
    },
    {
        time: "6 min",
        heading: 'Resume & Interview Tips',
        heading2: 'Boost your chances of getting hired',
        name: "Published on CareerBoost",
    ...
    {
        time: "7 min",
        heading: 'Choosing Your Career Path',
        heading2: 'Expert advice to make decisions easier',
        name: "Published on GuidancePro",
        date: 'August 25, 2025',
        imgSrc: '/images/articles/article3.png',
    },
